...
class GetRandomExcuses extends UseCase<List<ExcuseModel>, ExcuseParams> {
  final ExcuseRepository repository;

  GetRandomExcuses(this.repository);

  @override
  Future<Either<AppError, List<ExcuseModel>>> call(ExcuseParams params) async {
    return await repository.getRandomExcuses(params.noe);
  }
}
